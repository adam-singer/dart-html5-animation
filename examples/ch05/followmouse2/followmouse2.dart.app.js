...
// ********** Code for top level **************
//  ********** Library followmouse2 **************
// ********** Code for followmouse2 **************
function followmouse2() {

}
followmouse2.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    var dx = $sub(mouse.get$x(), arrow.get$x()), dy = $sub(mouse.get$y(), arrow.get$y()), angle = Math.atan2(dy, dx), ax = $mul(Math.cos(angle), force), ay = $mul(Math.sin(angle), force);
    arrow.set$rotation(angle);
    vx = $add(vx, ax);
    vy = $add(vy, ay);
    arrow.set$x($add(arrow.get$x(), vx));
    arrow.set$y($add(arrow.get$y(), vy));
    arrow.draw(context);
  }
  ;
  drawFrame((0));
...
Arrow.prototype.get$x = function() { return this.x; };
Arrow.prototype.set$x = function(value) { return this.x = value; };
Arrow.prototype.get$y = function() { return this.y; };
Arrow.prototype.set$y = function(value) { return this.y = value; };
Arrow.prototype.get$rotation = function() { return this.rotation; };
Arrow.prototype.set$rotation = function(value) { return this.rotation = value; };
