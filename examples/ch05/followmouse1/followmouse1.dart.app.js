...
// ********** Code for top level **************
//  ********** Library followmouse1 **************
// ********** Code for followmouse1 **************
function followmouse1() {

}
followmouse1.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    var dx = $sub(mouse.get$x(), arrow.get$x()), dy = $sub(mouse.get$y(), arrow.get$y()), angle = Math.atan2(dy, dx), vx = $mul(Math.cos(angle), speed), vy = $mul(Math.sin(angle), speed);
