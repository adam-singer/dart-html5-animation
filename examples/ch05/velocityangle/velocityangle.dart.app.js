...
//  ********** Library utilslib **************
// ********** Code for top level **************
//  ********** Library velocityangle **************
// ********** Code for velocityangle **************
function velocityangle() {

}
velocityangle.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    var radians = $mul(angle, (3.141592653589793)) / (180), vx = $mul(Math.cos(radians), speed), vy = $mul(Math.sin(radians), speed);
