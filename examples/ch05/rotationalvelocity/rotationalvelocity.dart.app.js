...
// ********** Code for top level **************
//  ********** Library rotationalvelocity **************
// ********** Code for rotationalvelocity **************
function rotationalvelocity() {

}
rotationalvelocity.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var arrow = new Arrow();
  var vr = (2);
  arrow.set$x(canvas.get$width() / (2));
  arrow.set$y(canvas.get$height() / (2));
  function drawFrame(t) {
    ...
    arrow.set$rotation(arrow.get$rotation() + ($mul(vr, (3.141592653589793)) / (180)));
    arrow.draw(context);
  }
  ;
  drawFrame((0));
