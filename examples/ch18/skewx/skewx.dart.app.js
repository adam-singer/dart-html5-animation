...
skewx.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    var skewX = ($sub(mouse.get$x(), canvas.get$width() / (2))) * (0.01), dx = canvas.get$width() / (2), dy = canvas.get$height() / (2);
    context.save();
    context.set$fillStyle("#ff0000");
    context.transform$6((1), (0), skewX, (1), dx, dy);
