...
//  ********** Library utilslib **************
// ********** Code for top level **************
//  ********** Library matrixrotate **************
// ********** Code for matrixrotate **************
function matrixrotate() {

}
matrixrotate.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    angle = $add(angle, (0.03));
    var cos = Math.cos(angle), sin = Math.sin(angle), dx = canvas.get$width() / (2), dy = canvas.get$height() / (2);
    context.save();
    context.set$fillStyle("#ff0000");
    context.transform$6(cos, sin, $negate(sin), cos, dx, dy);
