...
// ********** Code for CommentJs **************
// ********** Code for UIEventJs **************
$dynamic("get$keyCode").UIEvent = function() {
  return this.keyCode;
}
...
movecube2.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var points = [], triangles = [], fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), offsetX = (0), offsetY = (0), angleX = (0), angleY = (0);
  points.add$1(new Point3d((-100), (-100), (-100)));
  points.add$1(new Point3d((100), (-100), (-100)));
  points.add$1(new Point3d((100), (100), (-100)));
  points.add$1(new Point3d((-100), (100), (-100)));
  points.add$1(new Point3d((-100), (-100), (100)));
  ...
  triangles.add$1(new Triangle(points.$index((0)), points.$index((1)), points.$index((2)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((2)), points.$index((3)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((5)), points.$index((1)), "#66cc66"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((4)), points.$index((5)), "#66cc66"));
  triangles.add$1(new Triangle(points.$index((4)), points.$index((6)), points.$index((5)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((4)), points.$index((7)), points.$index((6)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((3)), points.$index((2)), points.$index((6)), "#cc66cc"));
  triangles.add$1(new Triangle(points.$index((3)), points.$index((6)), points.$index((7)), "#cc66cc"));
  triangles.add$1(new Triangle(points.$index((1)), points.$index((5)), points.$index((6)), "#66cccc"));
  triangles.add$1(new Triangle(points.$index((1)), points.$index((6)), points.$index((2)), "#66cccc"));
  triangles.add$1(new Triangle(points.$index((4)), points.$index((0)), points.$index((3)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((4)), points.$index((3)), points.$index((7)), "#cccc66"));
  html_get$window().get$on().get$keyDown().add((function (event) {
    var $0, $1, $2, $3;
    if ((($0 = event.get$keyCode()) == null ? null == ((37)) : $0 === (37))) {
      offsetX = $sub(offsetX, (5));
    }
    else if ((($1 = event.get$keyCode()) == null ? null == ((39)) : $1 === (39))) {
      offsetX = $add(offsetX, (5));
    }
    else if ((($2 = event.get$keyCode()) == null ? null == ((38)) : $2 === (38))) {
      offsetY = $sub(offsetY, (5));
    }
    else if ((($3 = event.get$keyCode()) == null ? null == ((40)) : $3 === (40))) {
      offsetY = $add(offsetY, (5));
    }
