...
pyramid.prototype.run = function() {
  ...
  points.add$1(new Point3d((0), (-100), (0)));
  ...
  triangles.add$1(new Triangle(points.$index((0)), points.$index((2)), points.$index((3)), "#66cc66"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((3)), points.$index((4)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((4)), points.$index((1)), "#66cccc"));
  triangles.add$1(new Triangle(points.$index((1)), points.$index((3)), points.$index((2)), "#cc66cc"));
  triangles.add$1(new Triangle(points.$index((1)), points.$index((4)), points.$index((3)), "#cc66cc"));
  function move(point) {
