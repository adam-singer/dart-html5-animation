...
lines3d2.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var points = [], numPoints = (50), fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), angleX = (0), angleY = (0);
  for (var point, i = (0);
   $lt(i, numPoints); i = $add(i, (1))) {
