...
spinninge.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var points = [], fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), angleX = (0), angleY = (0);
  points.add$1(new Point3d((-150), (-250), (100)));
  points.add$1(new Point3d((150), (-250), (100)));
  points.add$1(new Point3d((150), (-150), (100)));
  points.add$1(new Point3d((-50), (-150), (100)));
  points.add$1(new Point3d((-50), (-50), (100)));
  points.add$1(new Point3d((50), (-50), (100)));
  points.add$1(new Point3d((50), (50), (100)));
  points.add$1(new Point3d((-50), (50), (100)));
  points.add$1(new Point3d((-50), (150), (100)));
  ...
  function drawFrame(t) {
    ...
    context.beginPath();
    context.moveTo$2(points.$index((0)).getScreenX(), points.$index((0)).getScreenY());
    var i = (0);
    points.forEach$1((function (p) {
      draw(p, i);
      i = $add(i, (1));
    })
    );
