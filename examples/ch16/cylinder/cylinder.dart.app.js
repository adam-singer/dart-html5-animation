...
cylinder.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var points = [], triangles = [], numFaces = (20), fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), angleX = (0), angleY = (0);
  for (var angle, xpos, ypos, i = (0), idx = (0);
   $lt(i, numFaces); i = $add(i, (1))) {
    angle = $mul($div((6.283185307179586), numFaces), i);
    xpos = Math.cos(angle) * (200);
    ypos = Math.sin(angle) * (200);
    points.add$1(new Point3d(xpos, ypos, (-100)));
    points.add$1(new Point3d(xpos, ypos, (100)));
    idx = $add(idx, (2));
  }
  ...
  var i = (0), idx = (0);
  for (; $lt(i, $sub(numFaces, (1))); i = $add(i, (1))) {
    triangles.add$1(new Triangle(points.$index(idx), points.$index($add(idx, (3))), points.$index($add(idx, (1))), "#6666cc"));
    triangles.add$1(new Triangle(points.$index(idx), points.$index($add(idx, (2))), points.$index($add(idx, (3))), "#6666cc"));
    idx = $add(idx, (2));
  }
  triangles.add$1(new Triangle(points.$index(idx), points.$index((1)), points.$index($add(idx, (1))), "#6666cc"));
  triangles.add$1(new Triangle(points.$index(idx), points.$index((0)), points.$index((1)), "#6666cc"));
  function move(point) {
