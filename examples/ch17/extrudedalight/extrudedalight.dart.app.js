...
$dynamic("set$strokeStyle").CanvasRenderingContext2D = function(value) {
...
$dynamic("get$offsetX").MouseEvent = function() {
  return this.offsetX;
}
$dynamic("get$offsetY").MouseEvent = function() {
  return this.offsetY;
}
...
$dynamic("get$offsetX").WheelEvent = function() {
  return this.offsetX;
}
$dynamic("get$offsetY").WheelEvent = function() {
  return this.offsetY;
}
...
MouseEventWrappingImplementation.prototype.get$offsetX = function() {
  return this._ptr.get$offsetX();
}
MouseEventWrappingImplementation.prototype.get$offsetY = function() {
  return this._ptr.get$offsetY();
}
...
WheelEventWrappingImplementation.prototype.get$offsetX = function() {
  return this._ptr.get$offsetX();
}
WheelEventWrappingImplementation.prototype.get$offsetY = function() {
  return this._ptr.get$offsetY();
}
...
Utils.parseColor = function(color, toNumber) {
  if ((null == toNumber ? null == (true) : toNumber === true)) {
    if ((typeof(color) == 'number')) {
      return ($bit_or(color, (0)));
    }
    if ((typeof(color) == 'string') && color.startsWith("#")) {
      var s = color;
      s = s.substring((1));
      var i = Math.parseInt(s);
      return i;
    }
  }
  else {
    if ((typeof(color) == 'number')) {
      ...
      var g;
      var b;
      r = ($bit_and(color, (16711680))) >> (16);
      g = ($bit_and(color, (65280))) >> (8);
      b = $bit_and(color, (255));
      return $add($add($add("#", r.toRadixString((16))), g.toRadixString((16))), b.toRadixString((16)));
    }
  }
}
Utils.captureMouse = function(element) {
  var mouse = new Mouse();
  element.get$on().get$mouseMove().add((function (e) {
...
Mouse.prototype.get$x = function() { return this.x; };
Mouse.prototype.set$x = function(value) { return this.x = value; };
Mouse.prototype.get$y = function() { return this.y; };
Mouse.prototype.set$y = function(value) { return this.y = value; };
// ********** Code for top level **************
//  ********** Library extrudedalight **************
// ********** Code for extrudedalight **************
function extrudedalight() {

}
extrudedalight.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var light = new Light(), points = [], triangles = [], fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), angleX = (0), angleY = (0);
  points.add$1(new Point3d((-50), (-250), (-50)));
  points.add$1(new Point3d((50), (-250), (-50)));
  points.add$1(new Point3d((200), (250), (-50)));
  points.add$1(new Point3d((100), (250), (-50)));
  points.add$1(new Point3d((50), (100), (-50)));
  points.add$1(new Point3d((-50), (100), (-50)));
  points.add$1(new Point3d((-100), (250), (-50)));
  points.add$1(new Point3d((-200), (250), (-50)));
  points.add$1(new Point3d((0), (-150), (-50)));
  points.add$1(new Point3d((50), (0), (-50)));
  points.add$1(new Point3d((-50), (0), (-50)));
  points.add$1(new Point3d((-50), (-250), (50)));
  points.add$1(new Point3d((50), (-250), (50)));
  points.add$1(new Point3d((200), (250), (50)));
  ...
  points.add$1(new Point3d((50), (0), (50)));
  points.add$1(new Point3d((-50), (0), (50)));
  points.forEach$1((function (point) {
    point.setVanishingPoint(vpX, vpY);
    point.setCenter((0), (0), (200));
  })
  );
  triangles.add$1(new Triangle(points.$index((0)), points.$index((1)), points.$index((8)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((1)), points.$index((9)), points.$index((8)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((1)), points.$index((2)), points.$index((9)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((2)), points.$index((4)), points.$index((9)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((2)), points.$index((3)), points.$index((4)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((4)), points.$index((5)), points.$index((9)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((9)), points.$index((5)), points.$index((10)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((5)), points.$index((6)), points.$index((7)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((5)), points.$index((7)), points.$index((10)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((10)), points.$index((7)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((8)), points.$index((10)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((11)), points.$index((19)), points.$index((12)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((12)), points.$index((19)), points.$index((20)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((12)), points.$index((20)), points.$index((13)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((13)), points.$index((20)), points.$index((15)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((13)), points.$index((15)), points.$index((14)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((15)), points.$index((20)), points.$index((16)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((20)), points.$index((21)), points.$index((16)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((16)), points.$index((18)), points.$index((17)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((16)), points.$index((21)), points.$index((18)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((11)), points.$index((18)), points.$index((21)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((11)), points.$index((21)), points.$index((19)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((11)), points.$index((1)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((11)), points.$index((12)), points.$index((1)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((1)), points.$index((12)), points.$index((2)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((12)), points.$index((13)), points.$index((2)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((3)), points.$index((2)), points.$index((14)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((2)), points.$index((13)), points.$index((14)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((4)), points.$index((3)), points.$index((15)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((3)), points.$index((14)), points.$index((15)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((5)), points.$index((4)), points.$index((16)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((4)), points.$index((15)), points.$index((16)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((6)), points.$index((5)), points.$index((17)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((5)), points.$index((16)), points.$index((17)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((7)), points.$index((6)), points.$index((18)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((6)), points.$index((17)), points.$index((18)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((7)), points.$index((11)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((7)), points.$index((18)), points.$index((11)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((8)), points.$index((9)), points.$index((19)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((9)), points.$index((20)), points.$index((19)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((9)), points.$index((10)), points.$index((20)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((10)), points.$index((21)), points.$index((20)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((10)), points.$index((8)), points.$index((21)), "#6666cc"));
  triangles.add$1(new Triangle(points.$index((8)), points.$index((19)), points.$index((21)), "#6666cc"));
  triangles.forEach$1((function (triangle) {
    triangle.set$light(light);
  })
  );
  function move(point) {
  ...
  function depth(a, b) {
    return ($sub(b.getDepth(), a.getDepth()));
  }
  function draw(triangle) {
    triangle.draw(context);
  }
  function drawFrame(t) {
    html_get$document().get$window().webkitRequestAnimationFrame(drawFrame, canvas);
    context.clearRect((0), (0), canvas.get$width(), canvas.get$height());
    angleX = ($sub(mouse.get$y(), vpY)) * (0.0005);
    angleY = ($sub(mouse.get$x(), vpX)) * (0.0005);
    points.forEach$1(move);
    triangles.sort$1(depth);
    triangles.forEach$1(draw);
  }
  drawFrame((0));
}
// ********** Code for Point3d **************
...
Point3d.prototype.get$x = function() { return this.x; };
Point3d.prototype.set$x = function(value) { return this.x = value; };
Point3d.prototype.get$y = function() { return this.y; };
Point3d.prototype.set$y = function(value) { return this.y = value; };
Point3d.prototype.get$z = function() { return this.z; };
Point3d.prototype.set$z = function(value) { return this.z = value; };
...
Point3d.prototype.rotateX = function(angleX) {
  var cosX = Math.cos(angleX), sinX = Math.sin(angleX), y1 = $mul(this.y, cosX) - $mul(this.z, sinX), z1 = $mul(this.z, cosX) + $mul(this.y, sinX);
  this.y = y1;
  this.z = z1;
}
Point3d.prototype.rotateY = function(angleY) {
  var cosY = Math.cos(angleY), sinY = Math.sin(angleY), x1 = $mul(this.x, cosY) - $mul(this.z, sinY), z1 = $mul(this.z, cosY) + $mul(this.x, sinY);
  this.x = x1;
  this.z = z1;
}
Point3d.prototype.getScreenX = function() {
  var scale = this.fl / (this.fl + this.z + this.cZ);
  return this.vpX + $mul((this.cX + this.x), scale);
}
Point3d.prototype.getScreenY = function() {
  var scale = this.fl / (this.fl + this.z + this.cZ);
  return this.vpY + $mul((this.cY + this.y), scale);
}
// ********** Code for Triangle **************
...
Triangle.prototype.get$lineWidth = function() { return this.lineWidth; };
Triangle.prototype.set$lineWidth = function(value) { return this.lineWidth = value; };
Triangle.prototype.get$light = function() { return this.light; };
Triangle.prototype.set$light = function(value) { return this.light = value; };
Triangle.prototype.draw = function(context) {
  ...
  context.set$fillStyle(this.getAdjustedColor());
  context.set$strokeStyle(this.getAdjustedColor());
  context.beginPath();
  context.moveTo$2(this.pointA.getScreenX(), this.pointA.getScreenY());
...
Triangle.prototype.isBackface = function() {
  var cax = $sub(this.pointC.getScreenX(), this.pointA.getScreenX()), cay = $sub(this.pointC.getScreenY(), this.pointA.getScreenY()), bcx = $sub(this.pointB.getScreenX(), this.pointC.getScreenX()), bcy = $sub(this.pointB.getScreenY(), this.pointC.getScreenY());
  return $mul(cax, bcy) > $mul(cay, bcx);
}
Triangle.prototype.getAdjustedColor = function() {
  var _color = Math.parseInt($add("0x", this.color.substring((1)))), red = _color >> (16), green = _color >> (8) & (255), blue = _color & (255), lightFactor = this.getLightFactor();
  red *= lightFactor;
  green *= lightFactor;
  blue *= lightFactor;
  return Utils.parseColor(red << (16) | green << (8) | blue, false);
}
Triangle.prototype.getLightFactor = function() {
  var ab = new Light.withParameters$ctor(this.pointA.x - this.pointB.x, this.pointA.y - this.pointB.y, this.pointA.z - this.pointB.z);
  var bc = new Light.withParameters$ctor(this.pointB.x - this.pointC.x, this.pointB.y - this.pointC.y, this.pointB.z - this.pointC.z);
  var norm = new Light.withParameters$ctor(($mul(ab.get$y(), bc.get$z())) - ($mul(ab.get$z(), bc.get$y())), -(($mul(ab.get$x(), bc.get$z())) - ($mul(ab.get$z(), bc.get$x()))), ($mul(ab.get$x(), bc.get$y())) - ($mul(ab.get$y(), bc.get$x())));
  var dotProd = $mul(norm.get$x(), this.light.x) + $mul(norm.get$y(), this.light.y) + $mul(norm.get$z(), this.light.z);
  var normMag = Math.sqrt($mul(norm.get$x(), norm.get$x()) + $mul(norm.get$y(), norm.get$y()) + $mul(norm.get$z(), norm.get$z()));
  var lightMag = Math.sqrt(this.light.x * this.light.x + this.light.y * this.light.y + this.light.z * this.light.z);
  return (Math.acos($div(dotProd, ($mul(normMag, lightMag)))) / (3.141592653589793)) * this.light.brightness;
}
// ********** Code for Light **************
function Light() {
  this.x = (-100);
...
Light.withParameters$ctor = function(x, y, z) {
  this.y = y;
  this.x = x;
  this.z = z;
  this.brightness = (1);
}
Light.withParameters$ctor.prototype = Light.prototype;
Light.prototype.get$x = function() { return this.x; };
Light.prototype.set$x = function(value) { return this.x = value; };
Light.prototype.get$y = function() { return this.y; };
Light.prototype.set$y = function(value) { return this.y = value; };
Light.prototype.get$z = function() { return this.z; };
Light.prototype.set$z = function(value) { return this.z = value; };
// ********** Code for top level **************
function main() {
  new extrudedalight().run();
}
// 120 dynamic types.
// 501 types
// 41 !leaf
