...
Utils.colorToRGB = function(color, alpha) {
  ...
  if ((typeof(color) == 'string') && color.startsWith("#")) {
    i = Math.parseInt($add("0x", color.substring$1((1))));
  }
  else {
    i = color;
  }
  ...
  var r = i >> (16) & (255), g = i >> (8) & (255), b = i & (255), a = ($lt(alpha, (0))) ? (0) : (($gt(alpha, (1))) ? (1) : alpha);
  if ((null == a ? null == ((1)) : a === (1))) {
    return $add($add($add($add($add($add("rgb(", r), ","), g), ","), b), ")");
  }
  else {
    return $add($add($add($add($add($add($add($add("rgba(", r), ","), g), ","), b), ","), a), ")");
  }
}
...
// ********** Code for top level **************
//  ********** Library extrudedadepth **************
// ********** Code for extrudedadepth **************
function extrudedadepth() {

}
extrudedadepth.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var points = [], triangles = [], fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), angleX = (0), angleY = (0);
  ...
  points.add$1(new Point3d((50), (0), (50)));
  points.add$1(new Point3d((-50), (0), (50)));
  points.forEach$1(function function_(point) {
  ...
  triangles.add$1(new Triangle(points.$index((11)), points.$index((19)), points.$index((12)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((12)), points.$index((19)), points.$index((20)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((12)), points.$index((20)), points.$index((13)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((13)), points.$index((20)), points.$index((15)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((13)), points.$index((15)), points.$index((14)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((15)), points.$index((20)), points.$index((16)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((20)), points.$index((21)), points.$index((16)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((16)), points.$index((18)), points.$index((17)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((16)), points.$index((21)), points.$index((18)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((11)), points.$index((18)), points.$index((21)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((11)), points.$index((21)), points.$index((19)), "#cc6666"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((11)), points.$index((1)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((11)), points.$index((12)), points.$index((1)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((1)), points.$index((12)), points.$index((2)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((12)), points.$index((13)), points.$index((2)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((3)), points.$index((2)), points.$index((14)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((2)), points.$index((13)), points.$index((14)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((4)), points.$index((3)), points.$index((15)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((3)), points.$index((14)), points.$index((15)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((5)), points.$index((4)), points.$index((16)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((4)), points.$index((15)), points.$index((16)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((6)), points.$index((5)), points.$index((17)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((5)), points.$index((16)), points.$index((17)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((7)), points.$index((6)), points.$index((18)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((6)), points.$index((17)), points.$index((18)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((0)), points.$index((7)), points.$index((11)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((7)), points.$index((18)), points.$index((11)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((8)), points.$index((9)), points.$index((19)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((9)), points.$index((20)), points.$index((19)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((9)), points.$index((10)), points.$index((20)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((10)), points.$index((21)), points.$index((20)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((10)), points.$index((8)), points.$index((21)), "#cccc66"));
  triangles.add$1(new Triangle(points.$index((8)), points.$index((19)), points.$index((21)), "#cccc66"));
  function move(point) {
...
Triangle.prototype.draw = function(context) {
  ...
  context.set$fillStyle((context.set$strokeStyle(($0 = Utils.colorToRGB(this.color, this.alpha))), $0));
  context.beginPath();
