...
// ********** Code for top level **************
//  ********** Library anglebounce **************
// ********** Code for anglebounce **************
function anglebounce() {

}
anglebounce.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    var x1 = $sub(ball.get$x(), line.get$x()), y1 = $sub(ball.get$y(), line.get$y()), x2 = $mul(cos, x1) + $mul(sin, y1), y2 = $mul(cos, y1) - $mul(sin, x1), vx1 = $mul(cos, ball.get$vx()) + $mul(sin, ball.get$vy()), vy1 = $mul(cos, ball.get$vy()) - $mul(sin, ball.get$vx());
