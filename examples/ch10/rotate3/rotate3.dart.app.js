...
rotate3.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var balls = new Array();
  var numBalls = (10), vr = (0.05), centerX = canvas.get$width() / (2), centerY = canvas.get$height() / (2), cos, sin;
  for (var ball, i = (0);
  ...
  function drawFrame(t) {
    ...
    var angle = ($sub(mouse.get$x(), centerX)) * (0.0005);
    cos = Math.cos(angle);
    sin = Math.sin(angle);
