...
//  ********** Library utilslib **************
// ********** Code for top level **************
//  ********** Library anglebounceopt **************
// ********** Code for anglebounceopt **************
function anglebounceopt() {

}
anglebounceopt.prototype.run = function() {
  ...
  line.set$x((50));
  line.set$y((200));
  line.set$rotation((0.17453292519943295));
  var cos = Math.cos(line.get$rotation()), sin = Math.sin(line.get$rotation());
  function drawFrame(t) {
    ...
    var x1 = $sub(ball.get$x(), line.get$x()), y1 = $sub(ball.get$y(), line.get$y()), y2 = $mul(cos, y1) - $mul(sin, x1);
