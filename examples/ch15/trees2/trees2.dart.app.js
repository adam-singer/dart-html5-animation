...
$dynamic("set$alpha").WebGLContextAttributes = function(value) {
  this.alpha = value;
}
...
trees2.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var trees = [], numTrees = (100), fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), floor = (50), ax = (0), ay = (0), az = (0), vx = (0), vy = (0), vz = (0), gravity = (0.3), friction = (0.95);
  for (var tree, i = (0);
   $lt(i, numTrees); i = $add(i, (1))) {
    tree = new Tree();
    tree.set$xpos(Math.random() * (2000) - (1000));
    tree.set$ypos(floor);
    tree.set$zpos(Math.random() * (10000));
    trees.add$1(tree);
  }
  ...
  , false);
  html_get$window().get$on().get$keyUp().add((function (event) {
    switch (event.get$keyCode()) {
      case (38):
      case (40):
  ...
  function move(tree) {
    var $0;
    tree.set$xpos($add(tree.get$xpos(), vx));
    tree.set$ypos($add(tree.get$ypos(), vy));
    tree.set$zpos($add(tree.get$zpos(), vz));
    if ($lt(tree.get$ypos(), floor)) {
      tree.set$ypos(floor);
    }
    if (tree.get$zpos() < $negate(fl)) {
      tree.set$zpos(tree.get$zpos() + (10000));
    }
    if (tree.get$zpos() > $sub((10000), fl)) {
      tree.set$zpos(tree.get$zpos() - (10000));
    }
    var scale = $div(fl, ($add(fl, tree.get$zpos())));
    tree.set$scaleX((tree.set$scaleY(($0 = scale)), $0));
    tree.set$x($add(vpX, $mul(tree.get$xpos(), scale)));
    tree.set$y($add(vpY, $mul(tree.get$ypos(), scale)));
    tree.set$alpha(scale);
  }
  function zSort(a, b) {
  ...
  function drawFrame(t) {
    ...
    vz = $add(vz, az);
    vy = $sub(vy, gravity);
    trees.forEach$1(move);
    vx = $mul(vx, friction);
    vy = $mul(vy, friction);
    vz = $mul(vz, friction);
    trees.sort$1(zSort);
    trees.forEach$1(draw);
  }
  drawFrame((0));
}
// ********** Code for Tree **************
...
Tree.prototype.get$x = function() { return this.x; };
Tree.prototype.set$x = function(value) { return this.x = value; };
Tree.prototype.get$y = function() { return this.y; };
Tree.prototype.set$y = function(value) { return this.y = value; };
Tree.prototype.get$xpos = function() { return this.xpos; };
Tree.prototype.set$xpos = function(value) { return this.xpos = value; };
Tree.prototype.get$ypos = function() { return this.ypos; };
Tree.prototype.set$ypos = function(value) { return this.ypos = value; };
Tree.prototype.get$zpos = function() { return this.zpos; };
Tree.prototype.set$zpos = function(value) { return this.zpos = value; };
Tree.prototype.get$scaleX = function() { return this.scaleX; };
Tree.prototype.set$scaleX = function(value) { return this.scaleX = value; };
Tree.prototype.get$scaleY = function() { return this.scaleY; };
Tree.prototype.set$scaleY = function(value) { return this.scaleY = value; };
Tree.prototype.get$alpha = function() { return this.alpha; };
Tree.prototype.set$alpha = function(value) { return this.alpha = value; };
Tree.prototype.get$lineWidth = function() { return this.lineWidth; };
Tree.prototype.set$lineWidth = function(value) { return this.lineWidth = value; };
Tree.prototype.draw = function(context) {
  ...
  context.set$strokeStyle(Utils.colorToRGB(this.color, this.alpha));
  context.beginPath();
  context.moveTo$2((0), (0));
  context.lineTo((0), this.branch.$index((0)));
  context.moveTo$2((0), this.branch.$index((1)));
  context.lineTo(this.branch.$index((2)), this.branch.$index((3)));
  context.moveTo$2((0), this.branch.$index((4)));
  context.lineTo(this.branch.$index((5)), this.branch.$index((6)));
  context.stroke();
  context.restore();
}
// ********** Code for top level **************
...
(function(){
  ...
  var v1/*AbstractWorker*/ = 'AbstractWorker|SharedWorker|Worker';
