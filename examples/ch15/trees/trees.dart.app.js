...
trees.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var _trees = [], numTrees = (100), fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), floor = (200), vz = (0), friction = (0.98);
  for (var tree, i = (0);
  ...
  html_get$window().get$on().get$keyDown().add((function (event) {
    var $0, $1;
    if ((($0 = event.get$keyCode()) == null ? null == ((38)) : $0 === (38))) {
      vz = $sub(vz, (1));
    }
    else if ((($1 = event.get$keyCode()) == null ? null == ((40)) : $1 === (40))) {
      vz = $add(vz, (1));
    }
  })
  , false);
  ...
  function drawFrame(t) {
    ...
    _trees.forEach$1(move);
    vz = $mul(vz, friction);
    _trees.sort$1(zSort);
    _trees.forEach$1(draw);
  }
  drawFrame((0));
}
// ********** Code for Tree **************
