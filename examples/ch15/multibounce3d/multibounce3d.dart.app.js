...
//  ********** Library utilslib **************
// ********** Code for top level **************
//  ********** Library multibounce3d **************
// ********** Code for multibounce3d **************
function multibounce3d() {

}
multibounce3d.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var balls = [];
  var numBalls = (50), fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), top = (-100), bottom = (100), left = (-100), right = (100), back = (100), front = (-100);
  for (var ball, i = (0);
   $lt(i, numBalls); i = $add(i, (1))) {
    ball = new Ball3d.withRadius$ctor((15));
    ball.set$vx(Math.random() * (10) - (5));
    ball.set$vy(Math.random() * (10) - (5));
    ball.set$vz(Math.random() * (10) - (5));
    balls.add$1(ball);
  }
  function move(ball) {
    var $0;
