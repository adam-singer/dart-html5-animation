...
velocity3d.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var ball = new Ball();
  var xpos = (0), ypos = (0), zpos = (0), vx = (0), vy = (0), vz = (0), friction = (0.98), fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2);
...
(function(){
  ...
  var v2/*UIEvent*/ = 'UIEvent|CompositionEvent|KeyboardEvent|MouseEvent|SVGZoomEvent|TextEvent|TouchEvent|WheelEvent';
