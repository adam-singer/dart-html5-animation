...
// ********** Code for top level **************
//  ********** Library perspective2 **************
// ********** Code for perspective2 **************
function perspective2() {

}
perspective2.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var ball = new Ball();
  var xpos = (0), ypos = (0), zpos = (0), fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2);
  ...
  function drawFrame(t) {
    ...
    if ($gt(zpos, $negate(fl))) {
      var scale = $div(fl, ($add(fl, zpos)));
      xpos = $sub(mouse.get$x(), vpX);
      ypos = $sub(mouse.get$y(), vpY);
      ball.set$scaleX((ball.set$scaleY(($0 = scale)), $0));
      ball.set$x($add(vpX, $mul(xpos, scale)));
      ball.set$y($add(vpY, $mul(ypos, scale)));
...
Ball.prototype.get$scaleX = function() { return this.scaleX; };
Ball.prototype.set$scaleX = function(value) { return this.scaleX = value; };
Ball.prototype.get$scaleY = function() { return this.scaleY; };
Ball.prototype.set$scaleY = function(value) { return this.scaleY = value; };
...
Ball.prototype.get$visible = function() { return this.visible; };
Ball.prototype.set$visible = function(value) { return this.visible = value; };
