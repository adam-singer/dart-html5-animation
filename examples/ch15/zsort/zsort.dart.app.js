...
zsort.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var balls = [], numBalls = (50), fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), top = (-100), bottom = (100), left = (-100), right = (100), back = (100), front = (-100);
  for (var ball, i = (0);
