...
// ********** Code for BarInfoJs **************
$dynamic("get$visible").BarInfo = function() {
  return this.visible;
}
...
$dynamic("set$color").HTMLBaseFontElement = function(value) {
  this.color = value;
}
...
$dynamic("set$color").HTMLFontElement = function(value) {
  this.color = value;
}
...
$dynamic("get$visible").ScriptProfileNode = function() {
  return this.visible;
}
...
FontElementWrappingImplementation.prototype.set$color = function(value) {
  this._ptr.set$color(value);
}
...
// ********** Code for top level **************
//  ********** Library collision3d **************
// ********** Code for collision3d **************
function collision3d() {

}
collision3d.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var balls = [], numBalls = (20), fl = (250), vpX = canvas.get$width() / (2), vpY = canvas.get$height() / (2), top = (-200), bottom = (200), left = (-200), right = (200), back = (200), front = (-200);
  for (var ball, i = (0);
   $lt(i, numBalls); i = $add(i, (1))) {
    ball = new Ball3d.withRadius$ctor((15));
    ball.set$xpos(Math.random() * (400) - (200));
    ball.set$ypos(Math.random() * (400) - (200));
    ball.set$zpos(Math.random() * (400) - (200));
    ball.set$vx(Math.random() * (5) - (1));
    ball.set$vy(Math.random() * (5) - (1));
    ball.set$vz(Math.random() * (5) - (1));
    balls.add$1(ball);
  }
  function move(ball) {
    var $0;
    ball.set$xpos(ball.get$xpos() + ball.get$vx());
    ball.set$ypos(ball.get$ypos() + ball.get$vy());
    ball.set$zpos(ball.get$zpos() + ball.get$vz());
    if ($gt(ball.get$xpos() + ball.get$radius(), right)) {
      ball.set$xpos($sub(right, ball.get$radius()));
      ball.set$vx(ball.get$vx() * (-1));
    }
    else if ($lt(ball.get$xpos() - ball.get$radius(), left)) {
      ball.set$xpos($add(left, ball.get$radius()));
      ball.set$vx(ball.get$vx() * (-1));
    }
    if ($gt(ball.get$ypos() + ball.get$radius(), bottom)) {
      ball.set$ypos($sub(bottom, ball.get$radius()));
      ball.set$vy(ball.get$vy() * (-1));
    }
    else if ($lt(ball.get$ypos() - ball.get$radius(), top)) {
      ball.set$ypos($add(top, ball.get$radius()));
      ball.set$vy(ball.get$vy() * (-1));
    }
    if ($gt(ball.get$zpos() + ball.get$radius(), back)) {
      ball.set$zpos($sub(back, ball.get$radius()));
      ball.set$vz(ball.get$vz() * (-1));
    }
    else if ($lt(ball.get$zpos() - ball.get$radius(), front)) {
      ball.set$zpos($add(front, ball.get$radius()));
      ball.set$vz(ball.get$vz() * (-1));
    }
    if (ball.get$zpos() > $negate(fl)) {
      var scale = $div(fl, ($add(fl, ball.get$zpos())));
      ball.set$scaleX((ball.set$scaleY(($0 = scale)), $0));
      ball.set$x($add(vpX, $mul(ball.get$xpos(), scale)));
      ball.set$y($add(vpY, $mul(ball.get$ypos(), scale)));
      ball.set$visible(true);
    }
    else {
  ...
  function checkCollision(ballA, i) {
    for (var ballB, dx, dy, dz, dist, j = $add(i, (1));
     $lt(j, numBalls); j = $add(j, (1))) {
      ballB = balls.$index(j);
      dx = ballA.get$xpos() - ballB.get$xpos();
      dy = ballA.get$ypos() - ballB.get$ypos();
      dz = ballA.get$zpos() - ballB.get$zpos();
      dist = Math.sqrt($mul(dx, dx) + $mul(dy, dy) + $mul(dz, dz));
      if ($lt(dist, ballA.get$radius() + ballB.get$radius())) {
        ballA.set$color("#0000ff");
        ballB.set$color("#0000ff");
      }
    }
  }
  function zSort(a, b) {
    return (b.get$zpos() - a.get$zpos());
  }
  function draw(ball) {
    if (ball.get$visible()) {
      ball.draw(context);
  ...
  function drawFrame(t) {
    ...
    balls.forEach$1(move);
    var i = (0);
    balls.forEach$1((function (b) {
      checkCollision(b, i);
      i = $add(i, (1));
    })
    );
    balls.sort$1(zSort);
    balls.forEach$1(draw);
  }
  drawFrame((0));
}
// ********** Code for Ball3d **************
Ball3d.withRadius$ctor = function(radius) {
  this.radius = radius;
  this.color = "#ff0000";
  this._defaultValues();
}
Ball3d.withRadius$ctor.prototype = Ball3d.prototype;
function Ball3d() {}
Ball3d.prototype.get$color = function() { return this.color; };
Ball3d.prototype.set$color = function(value) { return this.color = value; };
Ball3d.prototype.get$radius = function() { return this.radius; };
Ball3d.prototype.set$radius = function(value) { return this.radius = value; };
Ball3d.prototype.get$x = function() { return this.x; };
Ball3d.prototype.set$x = function(value) { return this.x = value; };
Ball3d.prototype.get$y = function() { return this.y; };
Ball3d.prototype.set$y = function(value) { return this.y = value; };
Ball3d.prototype.get$xpos = function() { return this.xpos; };
Ball3d.prototype.set$xpos = function(value) { return this.xpos = value; };
Ball3d.prototype.get$ypos = function() { return this.ypos; };
Ball3d.prototype.set$ypos = function(value) { return this.ypos = value; };
Ball3d.prototype.get$zpos = function() { return this.zpos; };
Ball3d.prototype.set$zpos = function(value) { return this.zpos = value; };
Ball3d.prototype.get$vx = function() { return this.vx; };
Ball3d.prototype.set$vx = function(value) { return this.vx = value; };
Ball3d.prototype.get$vy = function() { return this.vy; };
Ball3d.prototype.set$vy = function(value) { return this.vy = value; };
Ball3d.prototype.get$vz = function() { return this.vz; };
Ball3d.prototype.set$vz = function(value) { return this.vz = value; };
Ball3d.prototype.get$scaleX = function() { return this.scaleX; };
Ball3d.prototype.set$scaleX = function(value) { return this.scaleX = value; };
Ball3d.prototype.get$scaleY = function() { return this.scaleY; };
Ball3d.prototype.set$scaleY = function(value) { return this.scaleY = value; };
Ball3d.prototype.get$lineWidth = function() { return this.lineWidth; };
Ball3d.prototype.set$lineWidth = function(value) { return this.lineWidth = value; };
Ball3d.prototype.get$visible = function() { return this.visible; };
Ball3d.prototype.set$visible = function(value) { return this.visible = value; };
Ball3d.prototype._defaultValues = function() {
  this.x = (0);
  this.y = (0);
  this.xpos = (0);
  this.ypos = (0);
