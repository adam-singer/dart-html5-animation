...
//  ********** Library utilslib **************
// ********** Code for top level **************
//  ********** Library gravitybounce **************
// ********** Code for gravitybounce **************
function gravitybounce() {

}
gravitybounce.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var particles = new Array();
  var numParticles = (30);
  for (var particle, i = (0);
   $lt(i, numParticles); i = $add(i, (1))) {
    particle = new Ball.withRadius$ctor((5));
