...
// ********** Code for top level **************
//  ********** Library mouseevents **************
// ********** Code for mouseevents **************
function mouseevents() {

}
mouseevents.prototype.run = function() {
  ...
  canvas.get$on().get$mouseDown().add((function (e) {
    if (Utils.containsPoint(ball.getBounds(), mouse.get$x(), mouse.get$y())) {
      log.set$value("in ball: mousedown");
    }
    else {
      log.set$value("canvas: mousedown");
    }
  })
  , false);
  canvas.get$on().get$mouseUp().add((function (e) {
    if (Utils.containsPoint(ball.getBounds(), mouse.get$x(), mouse.get$y())) {
      log.set$value("in ball: mouseup");
    }
    else {
      log.set$value("canvas: mouseup");
    }
  })
  , false);
  canvas.get$on().get$mouseMove().add((function (e) {
    if (Utils.containsPoint(ball.getBounds(), mouse.get$x(), mouse.get$y())) {
      log.set$value("in ball: mousemove");
    }
    else {
      log.set$value("canvas: mousemove");
    }
  })
  , false);
}
