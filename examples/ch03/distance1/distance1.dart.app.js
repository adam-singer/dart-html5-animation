...
distance1.prototype.run = function() {
  ...
  var rect1 = new rectLocal(Math.random() * canvas.get$width(), Math.random() * canvas.get$height());
  context.set$fillStyle("#000000");
  context.fillRect($sub(rect1.get$x(), (2)), $sub(rect1.get$y(), (2)), (4), (4));
  var rect2 = new rectLocal(Math.random() * canvas.get$width(), Math.random() * canvas.get$height());
  context.set$fillStyle("#ff0000");
  context.fillRect($sub(rect2.get$x(), (2)), $sub(rect2.get$y(), (2)), (4), (4));
  var dx = $sub(rect1.get$x(), rect2.get$x());
  var dy = $sub(rect1.get$y(), rect2.get$y());
