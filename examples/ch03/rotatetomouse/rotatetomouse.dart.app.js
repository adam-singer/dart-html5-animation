...
// ********** Code for top level **************
//  ********** Library rotatetomouse **************
// ********** Code for rotatetomouse **************
function rotatetomouse() {

}
rotatetomouse.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    var dx = $sub(mouse.get$x(), arrow.get$x());
    var dy = $sub(mouse.get$y(), arrow.get$y());
    arrow.set$rotation(Math.atan2(dy, dx));
    arrow.draw(context);
  }
  ;
  drawFrame((0));
