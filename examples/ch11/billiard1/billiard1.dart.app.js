...
billiard1.prototype.run = function() {
  ...
  ball0.set$mass((2));
  ball0.set$x((50));
  ball0.set$y(canvas.get$height() / (2));
  ball0.set$vx((1));
  ball1.set$mass((1));
  ball1.set$x((300));
  ball1.set$y(canvas.get$height() / (2));
  ball1.set$vx((-1));
  function drawFrame(t) {
    ...
    var dist = $sub(ball1.get$x(), ball0.get$x());
    if (dist.abs() < ball0.get$radius() + ball1.get$radius()) {
      var vx0Final = ((ball0.get$mass() - ball1.get$mass()) * ball0.get$vx() + (2) * ball1.get$mass() * ball1.get$vx()) / (ball0.get$mass() + ball1.get$mass()), vx1Final = ((ball1.get$mass() - ball0.get$mass()) * ball1.get$vx() + (2) * ball0.get$mass() * ball0.get$vx()) / (ball0.get$mass() + ball1.get$mass());
      ball0.set$vx(vx0Final);
      ball1.set$vx(vx1Final);
      ball0.set$x($add(ball0.get$x(), ball0.get$vx()));
      ball1.set$y($add(ball1.get$y(), ball1.get$vx()));
    }
    ball0.draw(context);
    ball1.draw(context);
  }
