...
billiard4.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var ball0 = new Ball.withRadius$ctor((80));
  var ball1 = new Ball.withRadius$ctor((40));
  var bounce = (-1);
  ball0.set$mass((2));
  ball0.set$x(canvas.get$width() - (200));
  ball0.set$y(canvas.get$height() - (200));
  ball0.set$vx(Math.random() * (10) - (5));
  ball0.set$vy(Math.random() * (10) - (5));
  ball1.set$mass((1));
  ball1.set$x((100));
  ball1.set$y((100));
  ball1.set$vx(Math.random() * (10) - (5));
  ball1.set$vy(Math.random() * (10) - (5));
  ...
  function drawFrame(t) {
    ...
    ball0.set$x($add(ball0.get$x(), ball0.get$vx()));
    ball0.set$y($add(ball0.get$y(), ball0.get$vy()));
    ball1.set$x($add(ball1.get$x(), ball1.get$vx()));
    ball1.set$y($add(ball1.get$y(), ball1.get$vy()));
    checkCollision();
    checkWalls(ball0);
    checkWalls(ball1);
    ball0.draw(context);
