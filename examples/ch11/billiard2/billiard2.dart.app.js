...
billiard2.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    if (dist.abs() < ball0.get$radius() + ball1.get$radius()) {
      var vxTotal = ball0.get$vx() - ball1.get$vx();
      ball0.set$vx(((ball0.get$mass() - ball1.get$mass()) * ball0.get$vx() + (2) * ball1.get$mass() * ball1.get$vx()) / (ball0.get$mass() + ball1.get$mass()));
      ball1.set$vx($add(vxTotal, ball0.get$vx()));
      ball0.set$x($add(ball0.get$x(), ball0.get$vx()));
