...
// ********** Code for top level **************
//  ********** Library doublespring **************
// ********** Code for doublespring **************
function doublespring() {

}
doublespring.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var ball0 = new Ball.withRadius$ctor((20)), ball1 = new Ball.withRadius$ctor((20)), ball0_dragging = false, ball1_dragging = false, spring = (0.03), friction = (0.9), springLength = (100), vx = (0), vy = (0);
