...
chain.prototype.run = function() {
  ...
  var ball0 = new Ball(), ball1 = new Ball(), ball2 = new Ball(), spring = (0.03), friction = (0.9), gravity = (2);
  ...
  function drawFrame(t) {
    ...
    move(ball0, mouse.get$x(), mouse.get$y());
    move(ball1, ball0.get$x(), ball0.get$y());
    move(ball2, ball1.get$x(), ball1.get$y());
    context.beginPath();
