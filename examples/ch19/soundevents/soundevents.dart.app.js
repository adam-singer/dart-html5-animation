...
$defProp(Object.prototype, "is$MediaElement", function() {
  return false;
});
...
MediaElementWrappingImplementation.prototype.is$MediaElement = function(){return true};
MediaElementWrappingImplementation.prototype.canPlayType = function(type) {
  return this._ptr.canPlayType(type);
}
MediaElementWrappingImplementation.prototype.play = function() {
  this._ptr.play();
  return;
}
...
AudioElementWrappingImplementation.prototype.is$MediaElement = function(){return true};
...
VideoElementWrappingImplementation.prototype.is$MediaElement = function(){return true};
...
// ********** Code for top level **************
//  ********** Library soundevents **************
// ********** Code for soundevents **************
function soundevents() {

}
soundevents.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var sound = html_get$document().query("#sound");
  var ball = new Ball(), vx = Math.random() * (10) - (5), vy = Math.random() * (10) - (5), bounce = (-0.7);
  ball.set$x(canvas.get$width() / (2));
  ball.set$y(canvas.get$height() / (2));
  if (!(!!(sound && sound.is$MediaElement()) && sound.canPlayType("audio/ogg").endsWith("maybe"))) {
    $throw(new ExceptionImplementation("The audio element is not supported in this browser."));
  }
