...
random5.prototype.run = function() {
  var $0;
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var numDots = (300);
  while (($0 = numDots, numDots = $sub(numDots, (1)), $0)) {
    var x1 = Math.random() * canvas.get$width(), x2 = Math.random() * canvas.get$width(), x = $div(($add(x1, x2)), (2)), y = canvas.get$height() / (2) + Math.random() * (50) - (25);
