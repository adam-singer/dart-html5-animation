...
random7.prototype.run = function() {
  var $0;
  ...
  while (($0 = numDots, numDots = $sub(numDots, (1)), $0)) {
    ...
    var ypos = (0);
    for (var i = (0);
     $lt(i, iterations); i = $add(i, (1))) {
      xpos = $add(xpos, (Math.random() * canvas.get$width()));
    }
    for (var j = (0);
     $lt(j, iterations); j = $add(j, (1))) {
      ypos = $add(ypos, (Math.random() * canvas.get$height()));
    }
    var x = $div(xpos, iterations), y = $div(ypos, iterations);
