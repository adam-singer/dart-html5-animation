...
timebased2.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var ball = new Ball(), start_time = new DateImplementation.now$ctor().value, fps = (15), vx = (300), vy = (-300), bounce = (-0.7);
  ...
  html_get$window().setInterval(drawFrame, ($div((1000), fps)).toInt());
}
// ********** Code for Ball **************
function Ball() {
  this.radius = (40);
