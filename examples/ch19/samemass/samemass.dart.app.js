...
samemass.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var balls = [], numBalls = (15), bounce = (-1), radius = (20);
  for (var ball, i = (0);
  ...
  function checkCollision(ball0, ball1) {
    ...
    if ($lt(dist, ball0.get$radius() + ball1.get$radius())) {
      var angle = Math.atan2(dy, dx), sin = Math.sin(angle), cos = Math.cos(angle), pos0 = new point((0), (0)), pos1 = rotate(dx, dy, sin, cos, true), vel0 = rotate(ball0.get$vx(), ball0.get$vy(), sin, cos, true), vel1 = rotate(ball1.get$vx(), ball1.get$vy(), sin, cos, true);
      var temp = vel0;
      vel0 = vel1;
      vel1 = temp;
  ...
  function drawFrame(t) {
    html_get$window().webkitRequestAnimationFrame(drawFrame, canvas);
