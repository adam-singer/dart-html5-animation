...
walking1.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    var angle = (Math.sin(cycle) * (90)) * (3.141592653589793) / (180);
    segment0.set$rotation(angle);
    segment1.set$rotation($add(segment0.get$rotation(), angle));
    segment1.set$x(segment0.getPin().get$x());
    segment1.set$y(segment0.getPin().get$y());
