...
walking5.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var segment0 = new Segment((100), (30)), segment1 = new Segment((100), (20)), segment2 = new Segment((100), (30)), segment3 = new Segment((100), (20)), speedSlider = new Slider((0), (0.2), (0.08)), thighRangeSlider = new Slider((0), (90), (45)), thighBaseSlider = new Slider((0), (180), (90)), calfRangeSlider = new Slider((0), (90), (45)), calfOffsetSlider = new Slider((-3.14), (3.14), (-1.57)), cycle = (0);
  segment0.set$x((200));
  segment0.set$y((200));
  ...
  function walk(segA, segB, cyc) {
    var angle0 = ($add($mul(Math.sin(cyc), thighRangeSlider.get$value()), thighBaseSlider.get$value())) * (3.141592653589793) / (180), angle1 = ($add($mul(Math.sin($add(cyc, calfOffsetSlider.get$value())), calfRangeSlider.get$value()), calfRangeSlider.get$value())) * (3.141592653589793) / (180);
