...
// ********** Code for top level **************
//  ********** Library twosegments1 **************
// ********** Code for twosegments1 **************
function twosegments1() {

}
twosegments1.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var segment0 = new Segment((100), (20)), segment1 = new Segment((100), (20)), slider0 = new Slider((-90), (90), (0)), slider1 = new Slider((-90), (90), (0));
  function drawFrame() {
    ...
    segment1.set$rotation($mul(slider1.get$value(), (3.141592653589793)) / (180));
