...
$defProp(Object.prototype, "rect$4", function($0, $1, $2, $3) {
  return this.noSuchMethod("rect", [$0, $1, $2, $3]);
});
...
$dynamic("rect$4").CanvasRenderingContext2D = function($0, $1, $2, $3) {
  return this.rect($0, $1, $2, $3);
};
...
CanvasRenderingContext2DWrappingImplementation.prototype.quadraticCurveTo = function(cpx, cpy, x, y) {
  this._ptr.quadraticCurveTo(cpx, cpy, x, y);
  return;
}
CanvasRenderingContext2DWrappingImplementation.prototype.rect = function(x, y, width, height) {
  this._ptr.rect(x, y, width, height);
  return;
}
...
CanvasRenderingContext2DWrappingImplementation.prototype.rect$4 = CanvasRenderingContext2DWrappingImplementation.prototype.rect;
...
Utils.containsPoint = function(rect, x, y) {
  return !($lt(x, rect.get$x()) || $gt(x, $add(rect.get$x(), rect.get$width())) || $lt(y, rect.get$y()) || $gt(y, $add(rect.get$y(), rect.get$height())));
}
...
realwalk.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var segment0 = new Segment((50), (15)), segment1 = new Segment((50), (10)), segment2 = new Segment((50), (15)), segment3 = new Segment((50), (10)), speedSlider = new Slider((0), (0.2), (0.08)), thighRangeSlider = new Slider((0), (90), (45)), thighBaseSlider = new Slider((0), (180), (90)), calfRangeSlider = new Slider((0), (90), (45)), calfOffsetSlider = new Slider((-3.14), (3.14), (-1.57)), gravitySlider = new Slider((0), (1), (0.2)), cycle = (0), vx = (0), vy = (0);
  segment0.set$x((200));
  segment0.set$y((200));
  segment1.set$x(segment0.getPin().get$x());
  segment1.set$y(segment0.getPin().get$y());
  segment2.set$x((200));
  segment2.set$y((200));
  segment3.set$x(segment2.getPin().get$x());
  segment3.set$y(segment2.getPin().get$y());
  speedSlider.set$x((10));
  speedSlider.set$y((10));
  speedSlider.captureMouse(canvas);
  thighRangeSlider.set$x((30));
  thighRangeSlider.set$y((10));
  thighRangeSlider.captureMouse(canvas);
  thighBaseSlider.set$x((50));
  thighBaseSlider.set$y((10));
  thighBaseSlider.captureMouse(canvas);
  calfRangeSlider.set$x((70));
  calfRangeSlider.set$y((10));
  calfRangeSlider.captureMouse(canvas);
  calfOffsetSlider.set$x((90));
  calfOffsetSlider.set$y((10));
  calfOffsetSlider.captureMouse(canvas);
  gravitySlider.set$x((110));
  gravitySlider.set$y((10));
  gravitySlider.captureMouse(canvas);
  function setVelocity() {
    vy = $add(vy, gravitySlider.get$value());
    segment0.set$x($add(segment0.get$x(), vx));
    segment0.set$y($add(segment0.get$y(), vy));
    segment2.set$x($add(segment2.get$x(), vx));
    segment2.set$y($add(segment2.get$y(), vy));
  }
  ;
  function walk(segA, segB, cyc) {
    var angle0 = ($add($mul(Math.sin(cyc), thighRangeSlider.get$value()), thighBaseSlider.get$value())) * (3.141592653589793) / (180), angle1 = ($add($mul(Math.sin($add(cyc, calfOffsetSlider.get$value())), calfRangeSlider.get$value()), calfRangeSlider.get$value())) * (3.141592653589793) / (180), foot = segB.getPin();
    segA.set$rotation(angle0);
    segB.set$rotation($add(segA.get$rotation(), angle1));
    segB.set$x(segA.getPin().get$x());
    segB.set$y(segA.getPin().get$y());
    segB.set$vx($sub(segB.getPin().get$x(), foot.get$x()));
    segB.set$vy($sub(segB.getPin().get$y(), foot.get$y()));
  }
  ;
  function checkFloor(seg) {
    var yMax = $add(seg.getPin().get$y(), ($div(seg.get$height(), (2))));
    if ($gt(yMax, canvas.get$height())) {
      var dy = $sub(yMax, canvas.get$height());
      segment0.set$y($sub(segment0.get$y(), dy));
      segment1.set$y($sub(segment1.get$y(), dy));
      segment2.set$y($sub(segment2.get$y(), dy));
      segment3.set$y($sub(segment3.get$y(), dy));
      vx = $sub(vx, seg.get$vx());
      vy = $sub(vy, seg.get$vy());
    }
  }
  ;
  function checkWalls() {
    var w = canvas.get$width() + (200);
    if ($gt(segment0.get$x(), canvas.get$width() + (100))) {
      segment0.set$x($sub(segment0.get$x(), w));
      segment1.set$x($sub(segment1.get$x(), w));
      segment2.set$x($sub(segment2.get$x(), w));
      segment3.set$x($sub(segment3.get$x(), w));
    }
    else if ($lt(segment0.get$x(), (-100))) {
      segment0.set$x($add(segment0.get$x(), w));
      segment1.set$x($add(segment1.get$x(), w));
      segment2.set$x($add(segment2.get$x(), w));
      segment3.set$x($add(segment3.get$x(), w));
    }
  }
  ;
  function drawFrame(t) {
    ...
    cycle = $add(cycle, speedSlider.get$value());
    setVelocity();
    walk(segment0, segment1, cycle);
    walk(segment2, segment3, $add(cycle, (3.141592653589793)));
    checkFloor(segment1);
    checkFloor(segment3);
    checkWalls();
...
Segment.prototype.get$x = function() { return this.x; };
Segment.prototype.set$x = function(value) { return this.x = value; };
Segment.prototype.get$y = function() { return this.y; };
Segment.prototype.set$y = function(value) { return this.y = value; };
Segment.prototype.get$width = function() { return this.width; };
Segment.prototype.set$width = function(value) { return this.width = value; };
Segment.prototype.get$height = function() { return this.height; };
Segment.prototype.set$height = function(value) { return this.height = value; };
Segment.prototype.get$vx = function() { return this.vx; };
Segment.prototype.set$vx = function(value) { return this.vx = value; };
Segment.prototype.get$vy = function() { return this.vy; };
Segment.prototype.set$vy = function(value) { return this.vy = value; };
Segment.prototype.get$rotation = function() { return this.rotation; };
Segment.prototype.set$rotation = function(value) { return this.rotation = value; };
Segment.prototype.get$lineWidth = function() { return this.lineWidth; };
Segment.prototype.set$lineWidth = function(value) { return this.lineWidth = value; };
Segment.prototype._defaultValues = function() {
  this.x = (0);
  this.y = (0);
  this.vx = (0);
  this.vy = (0);
...
Segment.prototype.draw = function(context) {
  var h = this.height, d = $add(this.width, h), cr = $div(h, (2));
  context.save();
  ...
  context.set$fillStyle(this.color);
  context.beginPath();
  context.moveTo$2((0), $negate(cr));
  context.lineTo($sub(d, $mul((2), cr)), $negate(cr));
  context.quadraticCurveTo($add($negate(cr), d), $negate(cr), $add($negate(cr), d), (0));
  context.lineTo($add($negate(cr), d), $sub(h, $mul((2), cr)));
  context.quadraticCurveTo($add($negate(cr), d), $add($negate(cr), h), $sub(d, $mul((2), cr)), $add($negate(cr), h));
  context.lineTo((0), $add($negate(cr), h));
  context.quadraticCurveTo($negate(cr), $add($negate(cr), h), $negate(cr), $sub(h, $mul((2), cr)));
  context.lineTo($negate(cr), (0));
  context.quadraticCurveTo($negate(cr), $negate(cr), (0), $negate(cr));
  context.closePath();
  context.fill();
  if (this.lineWidth > (0)) {
    context.stroke();
  ...
  context.beginPath();
  context.arc((0), (0), (2), (0), (6.283185307179586), true);
  context.closePath();
  context.stroke();
  context.beginPath();
  context.arc(this.width, (0), (2), (0), (6.283185307179586), true);
  context.closePath();
  context.stroke();
  context.restore();
}
Segment.prototype.getPin = function() {
  return new point(this.x + Math.cos(this.rotation) * this.width, this.y + Math.sin(this.rotation) * this.width);
}
// ********** Code for Slider **************
...
Slider.prototype.get$value = function() { return this.value; };
Slider.prototype.set$value = function(value) { return this.value = value; };
Slider.prototype.get$x = function() { return this.x; };
Slider.prototype.set$x = function(value) { return this.x = value; };
Slider.prototype.get$y = function() { return this.y; };
Slider.prototype.set$y = function(value) { return this.y = value; };
Slider.prototype.get$width = function() { return this.width; };
Slider.prototype.set$width = function(value) { return this.width = value; };
Slider.prototype.get$height = function() { return this.height; };
Slider.prototype.set$height = function(value) { return this.height = value; };
Slider.prototype.draw = function(context) {
  context.save();
  context.translate$2(this.x, this.y);
  context.set$fillStyle(this.backColor);
  context.beginPath();
  context.fillRect(this.backX, (0), this.backWidth, this.height);
  context.closePath();
  context.set$strokeStyle(this.handleBorderColor);
  context.set$fillStyle(this.handleColor);
  context.beginPath();
  context.rect$4((0), this.handleY, this.width, this.handleHeight);
  context.closePath();
  context.fill();
  context.stroke();
  context.restore();
...
Slider.prototype.updateValue = function() {
  var old_value = this.value, handleRange = this.height - this.handleHeight, valueRange = this.max - this.min;
  this.value = $mul($div(($sub(handleRange, this.handleY)), handleRange), valueRange) + this.min;
  if ((typeof(this.onchange) == 'function')) {
    this.onchange.call$0();
  }
}
Slider.prototype.updatePosition = function() {
  var handleRange = this.height - this.handleHeight, valueRange = this.max - this.min;
  this.handleY = $sub(handleRange, $mul(($div((this.value - this.min), valueRange)), handleRange));
}
Slider.prototype.captureMouse = function(element) {
  var $this = this; // closure support
  var mouse = Utils.captureMouse(element);
  var bounds = new localBound(this.x, this.y + this.handleY, this.width, this.handleHeight);
  function onMouseMove(event) {
    var pos_y = $sub(mouse.get$y(), $this.y);
    $this.handleY = Math.min($this.height - $this.handleHeight, Math.max(pos_y, (0)));
    $this.updateValue();
  }
  ;
  function onMouseUp(event) {
    element.get$on().get$mouseUp().remove(onMouseUp, false);
    element.get$on().get$mouseMove().remove(onMouseMove, false);
  }
  ;
  element.get$on().get$mouseDown().add((function (event) {
    if (Utils.containsPoint(bounds, mouse.get$x(), mouse.get$y())) {
      element.get$on().get$mouseUp().add(onMouseUp, false);
      element.get$on().get$mouseMove().add(onMouseMove, false);
    }
  })
  , false);
}
...
point.prototype.set$x = function(value) { return this.x = value; };
point.prototype.get$y = function() { return this.y; };
point.prototype.set$y = function(value) { return this.y = value; };
// ********** Code for localBound **************
function localBound(x, y, width, height) {
  this.y = y;
  this.width = width;
  this.x = x;
  this.height = height;
}
localBound.prototype.get$x = function() { return this.x; };
localBound.prototype.set$x = function(value) { return this.x = value; };
localBound.prototype.get$y = function() { return this.y; };
localBound.prototype.set$y = function(value) { return this.y = value; };
localBound.prototype.get$width = function() { return this.width; };
localBound.prototype.set$width = function(value) { return this.width = value; };
localBound.prototype.get$height = function() { return this.height; };
localBound.prototype.set$height = function(value) { return this.height = value; };
// ********** Code for top level **************
function main() {
  new realwalk().run();
}
...
(function(){
  ...
  var v4/*AudioParam*/ = 'AudioParam|AudioGain';
  var v5/*Entry*/ = 'Entry|DirectoryEntry|FileEntry';
  var v6/*EntrySync*/ = 'EntrySync|DirectoryEntrySync|FileEntrySync';
  ...
  var table = [
    ...
    , ['AudioParam', v4/*AudioParam*/]
    , ['Document', v0/*Document*/]
    , ['Entry', v5/*Entry*/]
    , ['EntrySync', v6/*EntrySync*/]
