...
WindowWrappingImplementation.prototype.set$onchange = function(value) {
  this._ptr.set$onchange(LevelDom.unwrap(value));
}
...
// ********** Code for top level **************
//  ********** Library twosegments2 **************
// ********** Code for twosegments2 **************
function twosegments2() {

}
twosegments2.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var segment0 = new Segment((100), (20)), segment1 = new Segment((100), (20)), slider0 = new Slider((-90), (90), (0)), slider1 = new Slider((-160), (0), (0));
  function drawFrame() {
    context.clearRect((0), (0), canvas.get$width(), canvas.get$height());
    segment0.set$rotation($mul(slider0.get$value(), (3.141592653589793)) / (180));
    segment1.set$rotation(segment0.get$rotation() + ($mul(slider1.get$value(), (3.141592653589793)) / (180)));
  ...
  slider0.set$onchange(drawFrame);
  slider1.set$x((340));
  slider1.set$y((20));
  slider1.captureMouse(canvas);
  slider1.set$onchange(drawFrame);
  drawFrame();
}
// ********** Code for Segment **************
...
Slider.prototype.get$onchange = function() { return this.onchange; };
Slider.prototype.set$onchange = function(value) { return this.onchange = value; };
