...
// ********** Code for top level **************
//  ********** Library singlesegment **************
// ********** Code for singlesegment **************
function singlesegment() {

}
singlesegment.prototype.run = function() {
  ...
  function drawFrame() {
    ...
    segment.set$rotation($mul(slider.get$value(), (3.141592653589793)) / (180));
    segment.draw(context);
    slider.draw(context);
  }
  slider.set$onchange(drawFrame);
  drawFrame();
}
// ********** Code for Segment **************
