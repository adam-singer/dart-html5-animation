...
walking2.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var segment0 = new Segment((100), (20)), segment1 = new Segment((100), (20)), cycle = (0);
  segment0.set$x((200));
  segment0.set$y((200));
  ...
  function drawFrame(t) {
    ...
    var angle0 = (Math.sin(cycle) * (45) + (90)) * (3.141592653589793) / (180), angle1 = (Math.sin(cycle) * (45) + (45)) * (3.141592653589793) / (180);
    segment0.set$rotation(angle0);
    segment1.set$rotation($add(segment0.get$rotation(), angle1));
    segment1.set$x(segment0.getPin().get$x());
    segment1.set$y(segment0.getPin().get$y());
