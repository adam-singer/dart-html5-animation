...
walking4.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var segment0 = new Segment((100), (30)), segment1 = new Segment((100), (20)), segment2 = new Segment((100), (30)), segment3 = new Segment((100), (20)), cycle = (0), offset = (-1.5707963267948966);
  segment0.set$x((200));
  segment0.set$y((200));
  ...
  function walk(segA, segB, cyc) {
    var angle0 = (Math.sin(cyc) * (45) + (90)) * (3.141592653589793) / (180), angle1 = (Math.sin($add(cyc, offset)) * (45) + (45)) * (3.141592653589793) / (180);
...
(function(){
  ...
  var v2/*Entry*/ = 'Entry|DirectoryEntry|FileEntry';
  var v3/*EntrySync*/ = 'EntrySync|DirectoryEntrySync|FileEntrySync';
