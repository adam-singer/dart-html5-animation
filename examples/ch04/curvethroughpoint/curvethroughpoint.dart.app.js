...
// ********** Code for top level **************
//  ********** Library curvethroughpoint **************
// ********** Code for curvethroughpoint **************
function curvethroughpoint() {

}
curvethroughpoint.prototype.run = function() {
  ...
  canvas.get$on().get$mouseMove().add((function (e) {
    ...
    var x1 = $mul(mouse.get$x(), (2)) - $div(($add(x0, x2)), (2)), y1 = $mul(mouse.get$y(), (2)) - $div(($add(y0, y2)), (2));
    context.beginPath();
    context.moveTo$2(x0, y0);
