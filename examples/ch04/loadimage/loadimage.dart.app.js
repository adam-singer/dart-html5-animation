...
$dynamic("set$src").HTMLMediaElement = function(value) {
  this.src = value;
}
...
$dynamic("set$src").HTMLEmbedElement = function(value) {
  this.src = value;
}
...
$dynamic("set$src").HTMLFrameElement = function(value) {
  this.src = value;
}
...
$dynamic("set$src").HTMLIFrameElement = function(value) {
  this.src = value;
}
// ********** Code for HTMLImageElementJs **************
$dynamic("set$src").HTMLImageElement = function(value) {
  this.src = value;
}
// ********** Code for HTMLInputElementJs **************
$dynamic("set$src").HTMLInputElement = function(value) {
  this.src = value;
}
...
$dynamic("set$src").HTMLScriptElement = function(value) {
  this.src = value;
}
...
$dynamic("set$src").HTMLSourceElement = function(value) {
  this.src = value;
}
...
$dynamic("set$src").HTMLTrackElement = function(value) {
  this.src = value;
}
...
loadimage.prototype.run = function() {
  ...
  var image = ElementWrappingImplementation.ElementWrappingImplementation$tag$factory("img");
  image.set$src("../assets/picture.jpg");
  image.get$on().get$load().add$2((function (e) {
    context.drawImage$3(image, (0), (0));
  })
  , false);
}
// ********** Code for top level **************
