...
grayscale.prototype.run = function() {
  ...
  for (var offset = (0), len = pixels.get$length();
   $lt(offset, len); offset = $add(offset, (4))) {
    var r = pixels.$index(offset), g = pixels.$index($add(offset, (1))), b = pixels.$index($add(offset, (2))), y = ($mul((0.2126), r)) + ($mul((0.7152), g)) + ($mul((0.0722), b));
    pixels.$setindex(offset, (pixels.$setindex($add(offset, (1)), ($3 = (pixels.$setindex($add(offset, (2)), ($2 = y)), $2))), $3));
  }
