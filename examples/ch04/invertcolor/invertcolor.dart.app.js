...
//  ********** Library invertcolor **************
// ********** Code for invertcolor **************
function invertcolor() {

}
invertcolor.prototype.run = function() {
  var $0, $1;
  ...
  for (var offset = (0), len = pixels.get$length();
   $lt(offset, len); offset = $add(offset, (4))) {
    pixels.$setindex(offset, $sub((255), pixels.$index(offset)));
    pixels.$setindex($add(offset, (1)), $sub((255), pixels.$index($add(offset, (1)))));
    pixels.$setindex($add(offset, (2)), $sub((255), pixels.$index($add(offset, (2)))));
  }
...
(function(){
  ...
  var v2/*CSSValueList*/ = 'CSSValueList|WebKitCSSFilterValue|WebKitCSSTransformValue';
