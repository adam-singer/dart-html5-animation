...
CanvasGradientWrappingImplementation.prototype.addColorStop = function(offset, color) {
  this._ptr.addColorStop(offset, color);
  return;
}
...
CanvasRenderingContext2DWrappingImplementation.prototype.createRadialGradient = function(x0, y0, r0, x1, y1, r1) {
  return LevelDom.wrapCanvasGradient(this._ptr.createRadialGradient(x0, y0, r0, x1, y1, r1));
}
...
// ********** Code for LevelDom **************
function LevelDom() {}
LevelDom.wrapCanvasGradient = function(raw) {
  return null == raw ? null : null != raw.get$dartObjectLocalStorage() ? raw.get$dartObjectLocalStorage() : new CanvasGradientWrappingImplementation._wrap$ctor(raw);
}
...
//  ********** Library gradientfillradial **************
// ********** Code for gradientfillradial **************
function gradientfillradial() {

}
gradientfillradial.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var c1 = new point.withRadius$ctor((150), (150), (0));
  var c2 = new point.withRadius$ctor((150), (150), (50));
  var gradient = context.createRadialGradient(c1.get$x(), c1.get$y(), c1.get$radius(), c2.get$x(), c2.get$y(), c2.get$radius());
...
// ********** Code for point **************
point.withRadius$ctor = function(x, y, radius) {
  this.y = y;
  this.x = x;
  this.radius = radius;
}
point.withRadius$ctor.prototype = point.prototype;
function point() {}
