...
//  ********** Library multicurve2 **************
// ********** Code for multicurve2 **************
function multicurve2() {

}
multicurve2.prototype.run = function() {
  ...
  for (var i = (0);
   $lt(i, numPoints); i = $add(i, (1))) {
    var p = new point(Math.random() * canvas.get$width(), Math.random() * canvas.get$height());
    points.add(p);
  }
  context.beginPath();
  context.moveTo$2(points.$index((0)).get$x(), points.$index((1)).get$y());
  var i = (1);
  for (; $lt(i, $sub(numPoints, (2))); i = $add(i, (1))) {
  ...
  context.quadraticCurveTo(points.$index(i).get$x(), points.$index(i).get$y(), points.$index($add(i, (1))).get$x(), points.$index($add(i, (1))).get$y());
  context.stroke();
}
// ********** Code for point **************
function point(x, y) {
