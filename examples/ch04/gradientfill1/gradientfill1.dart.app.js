...
CanvasRenderingContext2DWrappingImplementation.prototype.createLinearGradient = function(x0, y0, x1, y1) {
  return LevelDom.wrapCanvasGradient(this._ptr.createLinearGradient(x0, y0, x1, y1));
}
...
//  ********** Library gradientfill1 **************
// ********** Code for gradientfill1 **************
function gradientfill1() {

}
gradientfill1.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var pt1 = new point((0), (0));
  var pt2 = new point((100), (100));
  var gradient = context.createLinearGradient(pt1.x, pt1.y, pt2.x, pt2.y);
