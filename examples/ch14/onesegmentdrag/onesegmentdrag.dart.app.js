...
// ********** Code for top level **************
//  ********** Library onesegmentdrag **************
// ********** Code for onesegmentdrag **************
function onesegmentdrag() {

}
onesegmentdrag.prototype.run = function() {
  ...
  function drawFrame(t) {
    ...
    var dx = $sub(mouse.get$x(), segment0.get$x()), dy = $sub(mouse.get$y(), segment0.get$y());
    segment0.set$rotation(Math.atan2(dy, dx));
    var w = $sub(segment0.getPin().get$x(), segment0.get$x()), h = $sub(segment0.getPin().get$y(), segment0.get$y());
    segment0.set$x($sub(mouse.get$x(), w));
    segment0.set$y($sub(mouse.get$y(), h));
