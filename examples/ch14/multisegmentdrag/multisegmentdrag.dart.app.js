...
// ********** Code for top level **************
//  ********** Library multisegmentdrag **************
// ********** Code for multisegmentdrag **************
function multisegmentdrag() {

}
multisegmentdrag.prototype.run = function() {
  var $0;
  ...
  function drag(segment, xpos, ypos) {
    ...
    segment.set$x($sub(xpos, w));
    segment.set$y($sub(ypos, h));
  }
  function move(segment, i) {
    if ((null == i ? null != ((0)) : i !== (0))) {
      drag(segment, segments.$index($sub(i, (1))).get$x(), segments.$index($sub(i, (1))).get$y());
    }
  }
  ...
  function drawFrame(t) {
    ...
    drag(segments.$index((0)), mouse.get$x(), mouse.get$y());
    var i = (0);
