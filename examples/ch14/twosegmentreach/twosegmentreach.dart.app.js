...
// ********** Code for top level **************
//  ********** Library twosegmentreach **************
// ********** Code for twosegmentreach **************
function twosegmentreach() {

}
twosegmentreach.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var segment0 = new Segment((100), (20)), segment1 = new Segment((100), (20));
  segment1.set$x(canvas.get$width() / (2));
  segment1.set$y(canvas.get$height() / (2));
  ...
  function drawFrame(t) {
    ...
    var target = reach(segment0, mouse.get$x(), mouse.get$y());
    reach(segment1, target.get$x(), target.get$y());
