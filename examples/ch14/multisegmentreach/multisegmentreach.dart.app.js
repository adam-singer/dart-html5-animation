...
// ********** Code for top level **************
//  ********** Library multisegmentreach **************
// ********** Code for multisegmentreach **************
function multisegmentreach() {

}
multisegmentreach.prototype.run = function() {
  var $0;
  ...
  while (($0 = numSegments, numSegments = $sub(numSegments, (1)), $0)) {
    segments.add$1(new Segment((50), (10)));
  }
  ...
  function drawFrame(t) {
    ...
    target = reach(segments.$index((0)), mouse.get$x(), mouse.get$y());
    var i = (0);
...
(function(){
  ...
  var v4/*CSSValueList*/ = 'CSSValueList|WebKitCSSFilterValue|WebKitCSSTransformValue';
