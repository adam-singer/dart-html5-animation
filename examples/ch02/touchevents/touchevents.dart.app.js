...
touchevents.prototype.run = function() {
  ...
  ;
  canvas.get$on().get$touchStart().add(onTouchEvent, false);
  canvas.get$on().get$touchEnd().add(onTouchEvent, false);
  canvas.get$on().get$touchMove().add(onTouchEvent, false);
}
// ********** Code for top level **************
function main() {
  new touchevents().run();
