...
HashMapImplementation.prototype._probeForAdding = function(key) {
  ...
  while (true) {
    ...
    else if ((insertionIndex < (0)) && ((null == const$0004 ? null == (existingKey) : const$0004 === existingKey))) {
      insertionIndex = hash;
    }
...
HashMapImplementation.prototype._grow = function(newCapacity) {
  ...
  for (var i = (0);
   i < capacity; i++) {
    ...
    if (null == key || (null == key ? null == (const$0004) : key === const$0004)) {
      continue;
    }
...
HashMapImplementation.prototype.$setindex = function(key, value) {
  ...
  if ((null == this._keys.$index(index)) || ((($0 = this._keys.$index(index)) == null ? null == (const$0004) : $0 === const$0004))) {
...
HashSetIterator.prototype.hasNext = function() {
  ...
  if ((($0 = this._entries.$index(this._nextValidIndex)) == null ? null == (const$0004) : $0 === const$0004)) {
    this._advance();
  }
...
keynames.prototype.run = function() {
  function onKeyboardEvent(e) {
    switch (e.get$keyCode()) {
      case $globals.Keycode_UP:

        dart_core_print("up!");
        break;

      case $globals.Keycode_DOWN:

        dart_core_print("down!");
        break;

      case $globals.Keycode_LEFT:

        dart_core_print("left!");
        break;

      case $globals.Keycode_RIGHT:

        dart_core_print("right!");
        break;

      default:

        dart_core_print(("" + e.get$keyCode()));
        break;
...
function $static_init(){
  $globals.Keycode_DOWN = (40);
  $globals.Keycode_LEFT = (37);
  $globals.Keycode_RIGHT = (39);
  $globals.Keycode_UP = (38);
}
var const$0004 = Object.create(_DeletedKeySentinel.prototype, {});
