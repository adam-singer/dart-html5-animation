...
ElementEventsImplementation.prototype.get$dblClick = function() {
...
mouseevents.prototype.run = function() {
  ...
  ;
  canvas.get$on().get$mouseDown().add(onMouseEvent, false);
  canvas.get$on().get$mouseUp().add(onMouseEvent, false);
  canvas.get$on().get$click().add$2(onMouseEvent, false);
  canvas.get$on().get$dblClick().add(onMouseEvent, false);
  canvas.get$on().get$mouseWheel().add(onMouseEvent, false);
  canvas.get$on().get$mouseMove().add(onMouseEvent, false);
  canvas.get$on().get$mouseOver().add(onMouseEvent, false);
  canvas.get$on().get$mouseOut().add(onMouseEvent, false);
}
// ********** Code for top level **************
function main() {
  new mouseevents().run();
