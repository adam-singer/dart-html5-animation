...
// ********** Code for top level **************
//  ********** Library objecthittest **************
// ********** Code for objecthittest **************
function objecthittest() {

}
objecthittest.prototype.run = function() {
  var canvas = html_get$document().query("#canvas");
  var context = canvas.getContext("2d");
  var mouse = Utils.captureMouse(canvas);
  var log = html_get$document().query("#log");
  var ballA = new Ball(), ballB = new Ball();
  ballA.set$x(canvas.get$width() / (2));
  ballA.set$y(canvas.get$height() / (2));
  function drawFrame(t) {
    ...
    ballB.set$x(mouse.get$x());
    ballB.set$y(mouse.get$y());
    ...
    ballA.draw(context);
    ballB.draw(context);
    var boundsA = ballA.getBounds(), boundsB = ballB.getBounds();
    context.strokeRect$4(boundsA.get$x(), boundsA.get$y(), boundsA.get$width(), boundsA.get$height());
    context.strokeRect$4(boundsB.get$x(), boundsB.get$y(), boundsB.get$width(), boundsB.get$height());
  }
  ;
  drawFrame((0));
}
